...
parser.add_argument('--train_rule', default='None', type=str, help='data sampling strategy for train loader',choices=('None', 'DRW'))
parser.add_argument('--epochs', default=400, type=int, metavar='N',help='number of total epochs to run')
parser.add_argument('--lr', '--learning-rate', default=0.1, type=float,metavar='LR', help='initial learning rate', dest='lr')
parser.add_argument('--lr_steps', default=[320, 360], nargs='*', type=int,help='learning rate schedule (when to drop lr by 10x)')
...
parser.add_argument('--data_aug', default="MosaicMix", type=str, help='data augmentation type',
                    choices=('vanilla','MosaicMix'))
